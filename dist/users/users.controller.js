...
let UsersController = UsersController_1 = class UsersController {
    ...
    async atualizarUser(updateUserDto, _id) {
...
], UsersController.prototype, "criarUser", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], UsersController.prototype, "consultarUsers", null);
__decorate([
    common_1.Get('/:_id'),
    ...
    __metadata("design:returntype", Promise)
], UsersController.prototype, "consultarUsersKey", null);
__decorate([
    common_1.Put('/:_id'),
    __param(0, common_1.Body()),
    ...
    __metadata("design:returntype", Promise)
], UsersController.prototype, "atualizarUser", null);
__decorate([
    common_1.Delete('/:_id'),
    __param(0, common_1.Param('_id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], UsersController.prototype, "deletarUser", null);
