...
const categorias_schema_1 = require("./interfaces/categorias.schema");
let CategoriasModule = class CategoriasModule {
};
CategoriasModule = __decorate([
    common_1.Module({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: 'Categoria', schema: categorias_schema_1.CategoriaSchema }])
        ],
