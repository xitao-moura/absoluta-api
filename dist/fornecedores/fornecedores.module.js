...
const fornecedores_schema_1 = require("./interfaces/fornecedores.schema");
let FornecedoresModule = class FornecedoresModule {
};
FornecedoresModule = __decorate([
    common_1.Module({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: 'Fornecedor', schema: fornecedores_schema_1.FornecedorSchema }])
        ],
